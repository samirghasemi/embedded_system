###########################################################################
## Makefile generated for component 'p30'. 
## 
## Makefile     : p30.mk
## Generated on : Sun Jan 02 13:56:56 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/p30.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/p30.elf
...
DEFINES_STANDARD = -DMODEL=p30 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = p30.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/p30_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/p30_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/p30_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p30.o : $(START_DIR)/p30_ert_rtw/p30.c
	$(CC) $(CFLAGS) -o "$@" "$<"
