###########################################################################
## Makefile generated for component 'p301'. 
## 
## Makefile     : p301.mk
## Generated on : Mon Jan 03 15:19:07 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/p301.elf
...
START_DIR                 = D:/desktop/embedded/HW/embedded_system
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/p301.elf
...
DEFINES_STANDARD = -DMODEL=p301 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = p301.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/p301_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/p301_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/p301_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p301.o : $(START_DIR)/p301_ert_rtw/p301.c
	$(CC) $(CFLAGS) -o "$@" "$<"
