###########################################################################
## Makefile generated for component 'p31'. 
## 
## Makefile     : p31.mk
## Generated on : Sun Jan 02 13:34:27 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/p31.elf
...
START_DIR                 = D:/desktop/embedded/HW/embedded_system/p7
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/Abbas/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~2/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/p31.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=8 -DMW_TIMERCOUNT=65490 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=p31 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = p31.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/p31_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/p31_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/p31_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p31.o : $(START_DIR)/p31_ert_rtw/p31.c
	$(CC) $(CFLAGS) -o "$@" "$<"
