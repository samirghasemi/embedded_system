###########################################################################
## Makefile generated for component 'Chart1_ca'. 
## 
## Makefile     : Chart1_ca.mk
## Generated on : Wed Jan 26 15:28:35 2022
## Final product: ./Chart1_ca.a
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/Chart1_ert_rtw/coderassumptions/Chart1_ca.c
...
OBJS = coder_assumptions_hwimpl.o coder_assumptions_flt.o Chart1_ca.o
...
%.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/lib/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Chart1_ca.o : $(START_DIR)/Chart1_ert_rtw/coderassumptions/Chart1_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
