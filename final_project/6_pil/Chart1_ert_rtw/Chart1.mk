...
## 
## Makefile     : Chart1.mk
## Generated on : Wed Jan 26 15:28:16 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Chart1.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Chart1.elf
...
SRCS = $(START_DIR)/Chart1_ert_rtw/Chart1.c
...
%.o : $(START_DIR)/Chart1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Chart1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Chart1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Chart1.o : $(START_DIR)/Chart1_ert_rtw/Chart1.c
	$(CC) $(CFLAGS) -o "$@" "$<"
