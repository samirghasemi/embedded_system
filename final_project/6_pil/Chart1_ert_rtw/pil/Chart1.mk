###########################################################################
## Makefile generated for component 'Chart1'. 
## 
## Makefile     : Chart1.mk
## Generated on : Wed Jan 26 15:30:54 2022
## Final product: ./Chart1.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Chart1_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/EXTERN~1/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/Chart1_ert_rtw/pil -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc -I$(START_DIR)/Chart1_ert_rtw/coderassumptions -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/aIDE/hardware/arduino/avr/cores/arduino -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/aIDE/hardware/arduino/avr/variants/mega
...
DEFINES_STANDARD = -DMODEL=Chart1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ../Chart1.o

LIBS = $(START_DIR)/Chart1_ert_rtw/coderassumptions/lib/Chart1_ca.a
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) ../Chart1.o $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
xil_interface.o : $(START_DIR)/Chart1_ert_rtw/pil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"
