 ...
 *
 * PIL generated interface for code: "Chart1"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Chart1_U.on[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof
            (real32_T);
        ...
        {
          void * dataAddress = (void *) &(Chart1_U.off[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(Chart1_U.dif[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(Chart1_U.get[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(Chart1_U.x[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Chart1_Y.h1);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Chart1_Y.h2);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Chart1_Y.h3);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Chart1_Y.h4);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Chart1_Y.Room[0]);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 2 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Chart1_Y.Room[0]);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 2 * sizeof(real32_T);
          xil_fcnid0_task1_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
