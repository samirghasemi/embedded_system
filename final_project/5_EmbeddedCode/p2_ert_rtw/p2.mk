...
## 
## Makefile     : p2.mk
## Generated on : Tue Jan 25 20:05:28 2022
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/p2.elf
...
DEFINES_STANDARD = -DMODEL=p2 -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = p2.o p2_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/p2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/p2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/p2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p2.o : $(START_DIR)/p2_ert_rtw/p2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p2_data.o : $(START_DIR)/p2_ert_rtw/p2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
