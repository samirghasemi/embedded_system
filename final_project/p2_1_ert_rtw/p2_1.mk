###########################################################################
## Makefile generated for component 'p2_1'. 
## 
## Makefile     : p2_1.mk
## Generated on : Tue Jan 25 13:28:10 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/p2_1.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/p2_1.elf
...
DEFINES_STANDARD = -DMODEL=p2_1 -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = p2_1.o p2_1_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/p2_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/p2_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/p2_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p2_1.o : $(START_DIR)/p2_1_ert_rtw/p2_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


p2_1_data.o : $(START_DIR)/p2_1_ert_rtw/p2_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
