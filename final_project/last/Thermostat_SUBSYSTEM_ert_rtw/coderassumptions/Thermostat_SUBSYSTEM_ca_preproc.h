/*
 * File: Thermostat_SUBSYSTEM_ca_preproc.h
 *
...
#ifndef THERMOSTAT_SUBSYSTEM_CA_PREPROC_H
#define THERMOSTAT_SUBSYSTEM_CA_PREPROC_H
...
#endif                                 /* THERMOSTAT_SUBSYSTEM_CA_PREPROC_H */
