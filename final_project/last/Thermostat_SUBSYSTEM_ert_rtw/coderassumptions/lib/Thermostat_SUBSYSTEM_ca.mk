###########################################################################
## Makefile generated for component 'Thermostat_SUBSYSTEM_ca'. 
## 
## Makefile     : Thermostat_SUBSYSTEM_ca.mk
## Generated on : Tue Jan 25 18:05:06 2022
## Final product: ./Thermostat_SUBSYSTEM_ca.a
...
PRODUCT_NAME              = Thermostat_SUBSYSTEM_ca
MAKEFILE                  = Thermostat_SUBSYSTEM_ca.mk
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Thermostat_SUBSYSTEM_ca.a
...
PRODUCT = ./Thermostat_SUBSYSTEM_ca.a
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/Thermostat_SUBSYSTEM_ca.c
...
OBJS = coder_assumptions_hwimpl.o coder_assumptions_flt.o Thermostat_SUBSYSTEM_ca.o
...
%.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/lib/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Thermostat_SUBSYSTEM_ca.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/coderassumptions/Thermostat_SUBSYSTEM_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
