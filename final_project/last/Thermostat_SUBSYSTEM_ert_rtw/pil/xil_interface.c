 ...
 *
 * PIL generated interface for code: "Thermostat_SUBSYSTEM"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Thermostat_SUBSYSTEM_U.X[0]);
        ...
        {
          void * dataAddress = (void *) &(Thermostat_SUBSYSTEM_U.on[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(Thermostat_SUBSYSTEM_U.dif[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(Thermostat_SUBSYSTEM_U.off[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(Thermostat_SUBSYSTEM_U.get[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 4 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
