...
## Generated on : Tue Jan 25 18:04:41 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Thermostat_SUBSYSTEM.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Thermostat_SUBSYSTEM.elf
...
SRCS = $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/Thermostat_SUBSYSTEM.c
...
%.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Thermostat_SUBSYSTEM.o : $(START_DIR)/Thermostat_SUBSYSTEM_ert_rtw/Thermostat_SUBSYSTEM.c
	$(CC) $(CFLAGS) -o "$@" "$<"
