###########################################################################
## Makefile generated for component 'controller_SUBSYSTEM'. 
## 
## Makefile     : controller_SUBSYSTEM.mk
## Generated on : Tue Jan 25 18:08:06 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/controller_SUBSYSTEM.elf
...
PRODUCT_NAME              = controller_SUBSYSTEM
MAKEFILE                  = controller_SUBSYSTEM.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/controller_SUBSYSTEM.elf
...
DEFINES_STANDARD = -DMODEL=controller_SUBSYSTEM -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/controller_SUBSYSTEM_ert_rtw/controller_SUBSYSTEM.c
...
%.o : $(START_DIR)/controller_SUBSYSTEM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/controller_SUBSYSTEM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_SUBSYSTEM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
controller_SUBSYSTEM.o : $(START_DIR)/controller_SUBSYSTEM_ert_rtw/controller_SUBSYSTEM.c
	$(CC) $(CFLAGS) -o "$@" "$<"
