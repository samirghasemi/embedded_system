 ...
 * C/C++ source code generated on : Mon Jan  3 02:29:01 2022
 *
...
void untitled_step(void)
{
   ...
   *  Inport: '<Root>/f'
   */
  c_prev = untitled_DW.c_start;
  untitled_DW.c_start = untitled_U.c;
     ...
     case untitled_IN_state2:
      if (untitled_DW.is_state2 == untitled_IN_state6) {
        if (untitled_U.d == 1.0) {
          ...
          if (untitled_DW.is_e == untitled_IN_state10) {
            if ((untitled_U.c == 1.0) && (c_prev != untitled_DW.c_start)) {
              /* Outport: '<Root>/out10' */
              untitled_Y.out10 = 0.0;
              untitled_DW.is_e = untitled_IN_state11;
            } else {
            ...
            /* case IN_state11: */
          } else if ((untitled_U.c == 1.0) && (c_prev != untitled_DW.c_start)) {
...
//   digitalWrite(1, untitled_Y.out11);
// }